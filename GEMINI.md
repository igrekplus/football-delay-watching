...
| `02_design/` | HOW: どう実現するか（設計） | 設計変更時 |
| `03_operations/` | RUN: どう動かすか（運用） | インフラ変更時 |
| `GEMINI.md` | AI: 開発ガイド・AI指示書 | 都度 |

> **Note**: 旧 `04_llm_guides` は `GEMINI.md` に統合されました。
...
### 🏃 実行モード
> 詳細な仕様は [docs/03_operations/execution_mode.md](docs/03_operations/execution_mode.md) を参照。
...
詳細は [docs/03_operations/api_quota.md](docs/03_operations/api_quota.md) を参照。
