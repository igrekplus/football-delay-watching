...
> **📢 AI向け指示（必須）**: **モックモード・デバッグモード問わず、実行後は必ずデプロイすること！**
...
> **📢 AI向け指示**: デプロイ前に**必ず同期スクリプトを実行すること**。これをしないと、GitHub Actionsで生成されたレポートが消失する。
...
> **📢 AI向け指示**: Issue対応が完了したら、**必ずユーザーに「クローズしてよいか」確認すること**。勝手にIssueをクローズしてはならない。
...
> **📢 AI向け指示**: これはエンジニアリングの基本的なお作法。Issue対応後は必ず上記形式でコメントを残し、**コミットIDと変更内容を明記すること**。
