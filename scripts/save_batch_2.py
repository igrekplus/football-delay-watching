...
def save_content(data_path):
    ...
    for url, info in data.items():
        ...
        with open(os.path.join(save_dir, "text_before_transfer.txt"), 'w', encoding='utf-8') as f:
        ...
        meta = {
            ...
            "search_queries": ["Manchester City FC full history timeline", "Manchester City 2008 takeover Abu Dhabi United Group", "Manchester City Maine Road stadium history"],
            "source_type": "official" if "mancity.com" in url else ("encyclopedia" if "wikipedia" in url else ("media" if "bbc" in url or "guardian" in url else "database")),
