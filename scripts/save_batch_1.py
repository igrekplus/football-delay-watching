...
def save_content(data_path):
    ...
    for url, info in data.items():
        ...
        meta = {
            ...
            "search_queries": ["マンチェスター・シティFC 歴史 詳細", "マンチェスター・シティ 2008年 買収 影響", "マンチェスター・シティ メイン・ロード 歴史"],
            "source_type": "official" if "mancity.com" in url or "fifa.com" in url else ("encyclopedia" if "wikipedia" in url else "media"),
