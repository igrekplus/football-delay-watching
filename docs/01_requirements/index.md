...
| No. | 機能名 | 概要 | 詳細要件 |
|-----|--------|------|----------|
| 1 | 試合抽出機能 | 対象期間の試合を抽出 | [本ファイル 3.1](#31-試合抽出機能) |
| 2 | 試合選定機能 | 優先順位に基づき最大3試合を選定 | [本ファイル 3.2](#32-試合選定優先順位機能) |
| 3 | 固定情報取得機能 | スタメン・フォーメーション等を取得 | [本ファイル 3.3](#33-固定情報取得機能facts) |
| 4 | 試合前ニュース収集機能 | プレビュー記事を収集・フィルタリング | [本ファイル 3.4](#34-試合前ニュース収集フィルタリング機能) |
| 5 | 試合前ニュース要約機能 | 記事をAIで要約 | [本ファイル 3.5](#35-試合前ニュース要約機能) |
| 6 | 戦術プレビュー生成機能 | 戦術的見どころを生成 | [本ファイル 3.6](#36-戦術プレビュー生成機能) |
| 7 | ネタバレ検閲機能 | 禁止表現をフィルタリング | [本ファイル 3.7](#37-ネタバレ検閲機能禁止表現フィルタ) |
| 8 | レポート生成機能 | Markdownレポートを出力 | [本ファイル 3.8](#38-レポート生成機能) |
| 9 | 選外試合リスト出力機能 | 選外理由を記録 | [本ファイル 3.9](#39-選外試合リスト出力機能) |
| 10 | エラーハンドリング機能 | エラーレベルを管理 | [本ファイル 3.10](#310-エラーハンドリング機能) |
| 11 | YouTube動画取得機能 | 試合前動画を検索・取得 | [youtube_integration.md](./youtube_integration.md) |
