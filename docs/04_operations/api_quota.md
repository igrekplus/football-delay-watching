...
1日あたり対象リーグ: EPL/CL/LALIGA/FA/COPA/EFL、最大5試合（`Config.MATCH_LIMIT`）。

| API | 1試合あたり | 5試合/日 | 上限 | 消費率※ |
|-----|-----------|---------|------|---------|
| **API-Football** | ~25 req | ~125 req | 7,500/日 (Pro) | ✅ 2% |
| **YouTube Data API** | ~13クエリ=1,300 units | ~6,500 units | 10,000/日 | ⚠️ 65% |
| **Gemini** | ~20k tokens | ~100k tokens | 無料枠あり | ✅ |
| **Gmail** | 1通/日 | 1通/日 | 500/日 | ✅ 0.2% |

※ 消費率 = 5試合/日の消費量 ÷ 日次上限 × 100。低いほど余裕あり。
