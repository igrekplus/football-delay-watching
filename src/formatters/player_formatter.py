...
class PlayerFormatter:
    ...
    def format_player_cards(
        ...
        return render_template(
            "partials/player_card.html", css_class=css_class, players=players_data
        )

    def format_injury_cards(
        self,
        injuries_list: list,
        player_photos: dict[str, str] = None,
        ...
        return render_template(
            "partials/injury_card.html", css_class=css_class, injuries=injuries_data
        )
