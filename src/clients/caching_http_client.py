...
class CachingHttpClient:
    ...
    def _get_readable_cache_path(self, url: str, params: Dict[str, Any]) -> Tuple[str, str]:
        ...
        if endpoint == "players" and "id" in params:
            ...
            if "id" in params:
                ...
                return endpoint, f"fixtures/league_{params['league']}_season_{params['season']}.json"
    ...
    def _get_legacy_cache_path(self, url: str, params: Dict[str, Any], endpoint: str) -> str:
