...
if [ -n "${GCP_SERVICE_ACCOUNT_KEY:-}" ]; then
  ...
  SECRETS="API_FOOTBALL_KEY GOOGLE_API_KEY GOOGLE_SEARCH_ENGINE_ID GOOGLE_SEARCH_API_KEY YOUTUBE_API_KEY FIREBASE_CONFIG ALLOWED_EMAILS GITHUB_TOKEN ANTHROPIC_API_KEY"
  LOADED=0
  FAILED=0
